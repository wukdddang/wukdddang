...
| <details><summary>**21**</summary>React: 딥다이브 p.420-424 / Rust: 공식 가이드 p.26-30, Udemy 강의 섹션 2 완강 + 섹션 3.1-5 / JS: 완벽가이드 p.41-45 / TS: Udemy 강의 섹션 13.7-13 / BlockChain: 밑바닥부터 시작하는 비트코인 p.35-38</details> | <details><summary>**22**</summary>React: 딥다이브 p.425-431 / JS: 완벽가이드 p.46-50 / TS: Udemy 강의 섹션 13.14-15 / SQL: 자격검정 실전문제 2장 26-38번</details> | **23** | **24** | **25** | **26** | **27** |
| **28** | **29** | **30** |
